...
from GabiBraunRobot import DRAGONS, OWNER_ID, REDIS, dispatcher
...
def watchlist(update, context):
    ...
    if watchlist:
        ...
        message.reply_text("Your Watchlist is Empty!")
